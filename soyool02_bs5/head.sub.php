...
<!-- *** USER-ADDED VARIABLES JS -->
<script src="<?php echo G5_THEME_JS_URL ?>/user.custom.variables.js"></script>
...
<body<?php echo isset($g5['body_script']) ? $g5['body_script'] : ''; ?> class="bg-black">
<?php

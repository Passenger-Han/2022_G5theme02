...
<style TYPE="text/css">
	...
	#snb > li > ul > li a{display:block;padding:15px 30px;color:#676568;-webkit-transition-duration: 0.2s;-webkit-transition-timing-function: ease;transition-duration: 0.2s;transition-timing-function: ease;}
